...
const gigControllers_1 = require("../controllers/gigControllers");
 ...
 */
router.post('/create-gig', upload_1.default.array('gigImages', 3), gigControllers_1.createGig);
 ...
 *         description: Internal server error
 */
router.get('/get-gig/:gigId', gigControllers_1.getGigById);
/**
 * @swagger
 * /api/gig/{gigId}:
 *   put:
 ...
 *         description: Internal server error
 */
router.put('/:gigId', gigControllers_1.updateGig);
/**
 * @swagger
 * /api/gig/{gigId}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/delete/:gigId', gigControllers_1.deleteGig);
/**
 * @swagger
 * /api/gig/get-gigs:
 *   get:
 ...
 *         description: Internal server error
 */
router.get('/get-gigs', gigControllers_1.getGigs);
